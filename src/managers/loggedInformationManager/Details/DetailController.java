package managers.loggedInformationManager.Details;
...
public class DetailController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        try {
            universalTManager = new UniversalTManager(tabDetail, colDetail,"DODATKOWE_DETALE_OFERT");
    ...
    @FXML
    private TableView<String> tabDetail;
    ...
    void onAdd(ActionEvent event) {
        try {
            universalTManager.updateAdd(txtDetail.getText().toUpperCase());
            txtMessage.setText("");
        } catch (SQLException e) {
    ...
    void onDelete(ActionEvent event) {
        try {
            universalTManager.updateRemove(tabDetail.getSelectionModel().getSelectedItem());
            txtMessage.setText("");
